...
Built and operated by **Samim Hakimi** Detection Engineering & Security Operations | Security+ | CySA+ | Splunk | U.S. Army (HUMINT)

📍 San Diego, CA · [LinkedIn](https://linkedin.com/in/samimhakimi) · [Portfolio Site](https://sammyHa.github.io)


## What This Is
DeltaCode (`deltacode.local`) is a fully segmented enterprise network I designed, built, and operate daily on physical hardware. It runs the same detection, triage, and incident response workflows as a production SOC SIEM, EDR, NSM, SOAR, case management, email security, and adversary emulation which is mapped end-to-end to MITRE ATT&CK and NIST 800-61.
...
Detection (Wazuh / Suricata / Zeek)
        │
        ▼
Enrichment (Cortex analyzers: VirusTotal, AbuseIPDB, URLScan, Shodan)
        │
        ▼
...
<!-- Active in San Diego security community: BSidesSD, DC858 -->
- Currently completing CCDL2 from Cyberdefenders
